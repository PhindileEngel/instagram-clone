class App {
    ...
    this.$images = document.querySelector("#files");
    this.$message = document.querySelector("#caption");
...
this.displayPost();
        ...
        this.$images.addEventListener("change", (event) => {
        this.images(event);
            }) 

        this.$message.addEventListener("change", (event) => {
          ...
          send() {
            for (let i = 0; i < this.files.length; i++) {
              ...
              feed
                ...
                .catch((error) => {
                  console.log(error, "Error sending images!");
                });
            }
          }
